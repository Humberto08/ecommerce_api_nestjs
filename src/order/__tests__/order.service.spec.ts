    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        OrderService,
        {
          ...
          useValue: {
            createPayment: jest.fn().mockReturnValue(paymentMock),
          },
        },
        {
          provide: CartService,
          useValue: {
            findCartByUserId: jest.fn().mockReturnValue({
              ...cartMock,
        ...
        },
        {
          ...
          useValue: {
            createOrderProduct: jest.fn().mockReturnValue(orderProductMock),
          },
        },
        {
        ...
        },
        {
          ...
          useValue: {
            ...
            save: jest.fn().mockReturnValue(orderMock),
          },
        },
      ],
    }).compile();
